...
static const char[] spawnWav[]             = "sc/pdryes06.wav";
static const char[] deathWav[]             = "sc/pdrdth00.wav";
static const char[] thermalLanceWav[]      = "sc/phofir00.wav";
static const char[] thermalLanceHit[]      = "sc/phohit00.wav";
...
void NullFluxGenerator(client, null_flux_level)
{
    char upgradeName[64];
...
void ThermalLance(client, level)
{
    if (GetRestriction(client,Restriction_NoUltimates) ||
        GetRestriction(client,Restriction_Stunned))
    {
