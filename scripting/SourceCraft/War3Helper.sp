...
public int Native_War3_CachedAngle(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CachedPosition(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CachedDucking(Handle plugin,numParams)
{
    if(numParams==1)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CachedWeapon(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CachedClip1(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CachedAmmo(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CachedDeadClip1(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CachedDeadAmmo(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_CDWN(Handle plugin,numParams)
{
    if(numParams==4)
    {
        int client=GetNativeCell(1);
...
public int Native_War3_TF_PTC(Handle plugin,numParams)
{
    if(numParams==3)
    {
...
public int Native_War3_HTMHP(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client = GetNativeCell(1);
...
public int Native_War3_HTBHP(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client = GetNativeCell(1);
...
public int Native_War3_DecreaseHP(Handle plugin,numParams)
{
    if(numParams==2)
    {
        int client = GetNativeCell(1);
...
void DoFwd_War3_Event(W3EVENT:event,client)
{
    int dummyreturn;
...
public OnPlayerDeathEvent(Handle event,victim_index,victim_race, attacker_index,
                          ...
                          damage,const char[] weapon[], bool is_equipment,
...
public int Native_War3_GetWar3DamageDealt(Handle plugin,numParams)
{
...
public int Native_NotifyPlayerTookDamageFromSkill(Handle plugin, numParams)
{
...
public int Native_War3_DealDamage(Handle plugin,numParams)
{
...
public int NW3DropWeapon(Handle plugin, int numParams)
{
    ...
    if (hSDKWeaponDrop != null && ValidPlayer(client,true) && IsValidEdict(wpent))
...
stock AddRaceSkill(raceid,const char[] shortname[],const char[] name[],const char[] description[],bool isult=false,maxskilllevel=DEF_MAX_SKILL_LEVEL)
{
    char short[16];
...
stock fix_short(char buffer[], maxlength, const char[] short[])
{
