...
static const char[] spawnWav[]     = "sc/zdrrdy00.wav";
static const char[] deathWav[]     = "sc/zdrdth00.wav";
...
public OnSourceCraftReady()
{
    ...
    if (GameType == tf2)
    {
        ...
        m_MutateMultiplyEnergy = view_as<bool>(GetConfigNum("multiply_energy", true, raceID, mutateID));
        m_MutateMultiplyVespene = view_as<bool>(GetConfigNum("multiply_vespene", true, raceID, mutateID));
