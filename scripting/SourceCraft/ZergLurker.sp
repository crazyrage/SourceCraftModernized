...
static const char[] morphWav[]             = "sc/zlurdy00.wav";
static const char[] deathWav[]             = "sc/zludth00.wav";
static const char[] poisonHitWav[]         = "sc/spifir00.wav";
static const char[] poisonReadyWav[]       = "sc/zhyrdy00.wav";
static const char[] poisonExpireWav[]      = "sc/zhywht01.wav";
static const char[] spineAttackWav[][]     = { "sc/zlrkfir1.wav",  "sc/zlrkfir2.wav" };

static const char[] g_MissileAttackSound[] = "sc/zulhit00.wav";
...
void SpineAttack(client, level)
{
    ...
    {
        int float range = g_SpineRange[level];
