...
// Ward data structure
Handle g_hWardOwner = null; // Who owns this ward?
...
// Modular ward data
Handle g_hWardBehavior = null; // What is the ward behavior ID?
Handle g_hWardSkill = null; // What skill does this ward come from?
Handle g_hWardData = null; // Optional array of data to go with the ward
Handle g_hWardUseDefaultColors = null; // Bool: Should the ward use the default colors?
Handle g_hWardColor2 = null; // Alternate colors for Team 2
Handle g_hWardColor3 = null; // Alternate colors for Team 3

// Internal ward data
Handle g_hWardNextTick = null; // Internal: When is the next ward pulse?
Handle g_hWardExpireTime = null; // Internal: When will the ward expire?
Handle g_hWardEnabled = null; // Internal: Is this ward enabled?

// Event handles
Handle g_OnWardCreatedHandle = null;
Handle g_OnWardPulseHandle = null;
Handle g_OnWardTriggerHandle = null;
Handle g_OnWardExpireHandle = null;
...
public int Native_War3_GetWardCount(Handle plugin, numParams)
{
    return g_iPlayerWardCount[GetNativeCell(1)];
}

public int Native_War3_GetWardUseDefaultColor(Handle plugin, numParams)
{
    return bool GetArrayCell(g_hWardUseDefaultColors, GetNativeCell(1));
}

public int Native_War3_GetWardSkill(Handle plugin, numParams)
{
    return GetArrayCell(g_hWardSkill, GetNativeCell(1));
}

public int Native_War3_GetWardColor2(Handle plugin, numParams)
{
    int color[4];
...
public int Native_War3_GetWardColor3(Handle plugin, numParams)
{
    int color[4];
...
public int Native_War3_GetWardBehavior(Handle plugin, numParams)
{
    return GetArrayCell(g_hWardBehavior, GetNativeCell(1));
}

public int Native_War3_GetWardLocation(Handle plugin, numParams)
{
    float location[3];
...
public int Native_War3_GetWardInterval(Handle plugin, numParams)
{
    return GetArrayCell(g_hWardInterval, GetNativeCell(1));
}

public int Native_War3_GetWardRadius(Handle plugin, numParams)
{
    return GetArrayCell(g_hWardRadius,GetNativeCell(1));
}

public int Native_War3_GetWardOwner(Handle plugin, numParams)
{
    return GetArrayCell(g_hWardOwner, GetNativeCell(1));
}

public int Native_War3_GetWardData(Handle plugin, numParams)
{
...
public int Native_War3_CreateWard(Handle plugin, numParams)
{
...
public int Native_War3_CreateWardMod(Handle plugin, numParams)
{
    int client = GetNativeCell(1);
...
public int Native_War3_RemoveWard(Handle plugin, numParams)
{
