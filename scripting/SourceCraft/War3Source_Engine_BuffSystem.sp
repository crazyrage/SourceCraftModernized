...
public int Native_War3_SetBuff(Handle plugin,numParams)
{
...
public int Native_War3_SetBuffItem(Handle plugin,numParams) //buff is from an item
{
  if(numParams==4) //client,race,buffindex,value
  {
    int client=GetNativeCell(1);
...
public int Native_War3_SetBuffItem2(Handle plugin,numParams) //buff is from an item
{
  if(numParams==4) //client,race,buffindex,value
  {
    int client=GetNativeCell(1);
...
void SetBuff(client,W3Buff buffindex,itemraceindex,value)
{
...
void CalcBuffMinInt(client,W3Buff buffindex)
{  
  if(ValidBuff(buffindex))
  {
...
void GetBuffMinInt(client,W3Buff buffindex)
{
  if(ValidBuff(buffindex))
  { 
...
stock bool SCResetBuff(client, W3Buff buffindex, itemid, Handle pluginid=null)
{
    switch (buffindex)
    {
        case bBuffDenyAll: //DENY=not allowed to have any buffs, aka "purge"
...
stock SCResetAllBuff(client, Handle pluginid=null)
{
    SetROF(client, 0.0);
    UnFreezeEntity(client);
