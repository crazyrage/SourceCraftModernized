...
// Models
static const char[] mdlPackage[][] = { "models/items/crystal_ball_pickup.mdl", "models/items/currencypack_small.mdl",
                                    "models/items/currencypack_medium.mdl", "models/items/currencypack_large.mdl",
                                    "models/items/tf_gift.mdl" };

// Sound Files
static const char[] sndPickup[]  = "items/gift_pickup.wav";
static const char[] sndPain[][]  = { "player/pl_pain5.wav", "player/pl_pain6.wav",
