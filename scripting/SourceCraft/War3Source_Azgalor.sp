...
new char burnsnd[]="ambient/explosions/explode_4.wav";
new char catchsnd[]="npc/strider/fire.wav";
new char pitsnd[]="ambient/levels/labs/teleport_postblast_thunder1.wav";
new char riftsnd[]="weapons/irifle/irifle_fire2.wav";
new char ignitesnd[]="ambient/fire/gascan_ignite1.wav";
...
public RoundEvent(Handle event,const char[] name[],bool dontBroadcast)
{
    for(int x=1;x<=64;x++)
    {
