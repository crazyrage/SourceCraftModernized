...
{
	for(int ent=MaxClients+1;ent<ME;ent++)
...
public Action SelectPony(int client, int Args)
{
...
stock ZeIsValidEdict(int edict, const char[] class="0")
{
...
DoOverlay(int client, const char[] overlay)
{	
