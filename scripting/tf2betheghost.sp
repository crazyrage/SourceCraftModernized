...
Handle fwdCanPlayAsGhost = null;
Handle fwdCanBeScared = null;

Handle sm_tf2btg_version = null;
Handle sm_tf2btg_debug = null;
Handle sm_tf2btg_notify = null;
Handle sm_tf2btg_adminonly = null;
Handle sm_tf2btg_scary_delay = null;
Handle sm_tf2btg_scary_distance = null;
Handle sm_tf2btg_scary_distance_admin = null;
Handle sm_tf2btg_scary_duration = null;
Handle sm_tf2btg_scary_duration_admin = null;
Handle sm_tf2btg_ghost_speed = null;
Handle sm_tf2btg_ghost_speed_admin = null;
Handle sm_tf2btg_scary_objects = null;
Handle sm_tf2btg_spawnroom_protect = null;
...
public OnGameFrame()
{
	...
	int iClient, iGhost, float vecGhostOrigin[3], float vecClientOrigin[3], float flDistance;
	...
	if( !((iLastButtons[iClient] & IN_ATTACK2) == IN_ATTACK2) && (iButtons & IN_ATTACK2) == IN_ATTACK2 )
	{
		if( GetEntityRenderMode(iClient) == RENDER_NORMAL )
		{
			if( GameRules_GetRoundState() != RoundState_TeamWin )
			{
				...
				Timer_FixParticles( null, iClient );
...
DisableObjects( iGhost, float vecGhostOrigin[3], const char[] strClassname )
{
	...
	int iObject = -1, iOwner, float flDistance, float vecOrigin[3];
...
DropFlag( iClient )
{
	...
	int iFlag = -1, iCTeam = GetClientTeam(iClient);
